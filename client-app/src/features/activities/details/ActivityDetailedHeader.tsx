    ...
    return (
        <Segment.Group>
            {activity.isCancelled &&
                <Label syle={{position:'absolute', zIndex: 1000, left: -14, top: 20}} ribbon color='red' content='Cancelled' />
            }
                ...
                {activity.isHost ? (
                    <>
                        <Button 
                            ...
                            floated='left' basic content={activity.isCancelled ? 'Reactivate Activity' : 'Cancel Activity'}
